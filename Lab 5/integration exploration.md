# Lab 4: Integration Exploration

## Aryan Pericharan

### Used VS code with platformIO extension to create and upload code to the ESP32 from my Windows system

### 2 sensors used in the lab:
1. Ultrasonic Sensor 
2. LED Traffic Light Module 
### Code fo the integrated circuit can be found in the main.cpp file under src in Lab 5

### Cicuit Functionality
The ciircuit acts as an alert to the user. If any object gets closer than 50 cm to the sensor it will go from green to yellow on the traffic light module. If it is less than 20 cm to the sensor it will go to red. Changing the distance allows the different colors to transisiton.
...
Videos in the videos folder of the repo as well as commented in the canvas assignment 
